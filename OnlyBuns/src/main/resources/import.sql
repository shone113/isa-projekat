...
INSERT INTO public.users(email, followers_count, following_count, activation_token, name, password, posts_count, surname, longitude, latitude) VALUES ( 'aa@aa.aa', 0, 0, null, 'ss', '$2a$04$Vbug2lwwJGrvUXTj6z7ff.97IzVBkrJ1XfApfGNl.Z695zqcnPYra', 12, 'aa', 21.4489, 44.9866);
INSERT INTO public.users(email, followers_count, following_count, activation_token, name, password, posts_count, surname, longitude, latitude) VALUES ( 'admin@gmail.com', 1, 0, null, 'ss', '$2a$04$Vbug2lwwJGrvUXTj6z7ff.97IzVBkrJ1XfApfGNl.Z695zqcnPYra', 12, 'aa', 20.8489, 44.8866);
