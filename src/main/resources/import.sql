...
INSERT INTO public.users (email, followers_count, following_count, is_activated, name, password, posts_count, surname) VALUES ('neki@mail.com', 1, 1, false, 'neko', '123', 1, 'nekic');
INSERT INTO public.users(email, followers_count, following_count, is_activated, name, password, posts_count, surname) VALUES ( 'aa@aa.aa', 10, 10, FALSE, 'ss', 'aa', 12, 'aa');
