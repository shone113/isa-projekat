...
public class TokenUtils {
     ...
     *
     * @param token JWT token.
     * @param user Informacije o korisniku koji je vlasnik JWT tokena.
    ...
    public Boolean validateToken(String token, User user) {
        ...
        return (email != null // korisnicko ime nije null
                && email.equals(user.getUsername()) // korisnicko ime iz tokena se podudara sa korisnickom imenom koje pise u bazi
